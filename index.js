...
const totalContributions = GAMES_JSON.reduce((total, currGame) => { return total + currGame.backers; }, 0);
...
const amountRaised = GAMES_JSON.reduce((total, currGame) => { return total + currGame.pledged; }, 0);
...
function filterUnfundedOnly() {
    ...
    const unfundedGames = GAMES_JSON.filter(games => { return games.pledged < games.goal });
...
function filterFundedOnly() {
    ...
    const fundedGames = GAMES_JSON.filter(games => { return games.pledged >= games.goal });
